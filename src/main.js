...
function startQuiz(event) {
  ...
  function displayNextQuestionButton(handleNextQuestion) {
...
function formatId(text) {
  return text.replace(/[^a-z0-9-_]/gi, "-").toLowerCase();
}
...
function getFeedBackMessage(isCorrect, correct) {
  ...
  paragraph.innerText = isCorrect ? "Bravo ! tu as eu la bonne réponse" 
